...
function GetReviewSortDialog(props) {
	console.log('--GetReviewSortDialog');
	const {
		setDialog, //ダイアログの表示
		...
		<div className={styles.dialogBg}>
			<div className={styles.dialog}>
				...
				<div className={styles.selectTitle}>
					<p>コメント</p>
					<button type="button" className={`${commentAllBtnActive && styles.active} ${styles.allSelectBtn}`} onClick={AllChangeComment} >すべて選択</button>
				</div>                
				...
				<div className={styles.selectTitle}>
					<p>来場区分</p>
					<button type="button" className={`${divisionAllBtnActive && styles.active} ${styles.allSelectBtn}`} onClick={AllChangeDivision} >すべて選択</button>
				</div>
