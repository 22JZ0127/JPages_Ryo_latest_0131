...
function Header() {
	...
	return (
		<header className={styles[pageInfo[appState].color]}> 
			<h1 className={styles.logo}><div className={styles.logoImg} onClick={() => setAppState('home')}><img src={`/assets/img/home_${grade}jz_active.svg`} alt={activeTeam.num + 'トップ'}/></div></h1>
			<h2>
