...
import styles from './Hamburger6.module.scss';

function Hamburger6({onActivate, isActive}) {
	console.log('--Hamburger6');
	const toggleActive = () => {
	...
	<div className={`${styles.plate} ${isActive ? styles.active : ''}`} onClick={toggleActive}>
		<svg className={styles.burger} version="1.1" height="100" width="100" viewBox="0 0 100 100">
			...
			<path className={`${styles.line} ${styles.line2}`} d="M 70,50 H 30" />
			<path className={`${styles.line} ${styles.line3}`} d="M 30,35 H 70" />
		</svg>
