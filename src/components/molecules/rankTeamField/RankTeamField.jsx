	...
	return (
		<div className={styles.rankTeamField}>
			...
			<figure className={styles.teamIcon}>
				<img 
					src={`/assets/img/logo/${year}/${rankingData.num}`} alt={`${rankingData.num}logo`} 
...
export default RankTeamField;
				// <img src="https://placehold.jp/dddddd/555555/150x150.png?text=logo" alt="T01logo" />
